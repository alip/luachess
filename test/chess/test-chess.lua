...
TestChess = {} -- class
    function TestChess:test_01_switch_side()
        assert(chess.switch_side(WHITE) == BLACK)
        assert(chess.switch_side(BLACK) == WHITE)
    end
    function TestChess:test_02_piece_tostring()
    ...
    function TestChess:test_03_piece_toindex()
    ...
    function TestChess:test_04_rank()
    ...
    function TestChess:test_05_file()
    ...
    function TestChess:test_06_filec()
    ...
    function TestChess:test_07_squarei()
        for sq=0,63 do
            local sc = chess.squarec(sq)
            assert(chess.squarei(sc) == sq)
        end
    end
    function TestChess:test_08_square_left()
    ...
    function TestChess:test_09_square_right()
    ...
    function TestChess:test_10_square_up()
    ...
    function TestChess:test_11_square_down()
    ...
    function TestChess:test_12_square_border()
    ...
    function TestChess:test_13_move()
    ...
    function TestChess:test_14_capture_piece()
    ...
    function TestChess:test_14_promote_piece()
