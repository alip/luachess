...
module("test-move", lunit.testcase, package.seeall)
print"Loading move parser unit tests"
...
function test_06_return_false()
    assert(not move.return_false:match"foo")
end
function test_07_return_true()
    assert(move.return_true:match"bar")
end
function test_08_san_king()
...
function test_13_san_pawn()
    assert(move.san_pawn:match"" == PAWN, "failed to parse ''")
end
function test_14_san_piece()
...
function test_20_san_castle_long()
...
function test_21_san_disambiguity()
    for file=string.byte"a",string.byte"h" do
        for rank=1,8 do
...
function test_22_san_promotion()
...
function test_23_san_move_pawn()
...
function test_24_san_move_pawn_capture()
...
function test_25_san_move_pawn_check()
...
function test_26_san_move_pawn_promotion()
...
function test_27_san_move_pawn_capture_check()
    assert_move("axb7+", PAWN, "b7", "a", true, "+")
    assert_move("bxc6#", PAWN, "c6", "b", true, "#")
    assert_move("cxd5+", PAWN, "d5", "c", true, "+")
    assert_move("dxe4#", PAWN, "e4", "d", true, "#")
...
function test_28_san_move_pawn_capture_promotion()
...
function test_29_san_move_pawn_check_promotion()
...
function test_30_san_move_pawn_capture_check_promotion()
...
function test_31_san_move_piece()
...
function test_32_san_move_piece_capture()
...
function test_32_san_move_piece_check()
...
function test_33_san_move_piece_capture_check()
    assert_move("Kxf3+", KING, "f3", nil, true, "+")
    assert_move("Qxf8#", QUEEN, "f8", nil, true, "#")
    assert_move("Rxh5+", ROOK, "h5", nil, true, "+")
    assert_move("Bxd4#", BISHOP, "d4", nil, true, "#")
...
function test_35_san_move_piece_amb_file_check()
...
function test_36_san_move_piece_amb_file_capture_check()
    assert_move("Qaxd1+", QUEEN, "d1", "a", true, "+")
    assert_move("Rfxe8#", ROOK, "e8", "f", true, "#")
    assert_move("Baxf3+", BISHOP, "f3", "a", true, "+")
    assert_move("Ngxe2#", KNIGHT, "e2", "g", true, "#")
end
function test_37_san_move_piece_amb_rank()
    assert_move("Q1f3", QUEEN, "f3", "1")
    assert_move("R2d7", ROOK, "d7", "2")
    assert_move("B3f8", BISHOP, "f8", "3")
    assert_move("N1e2", KNIGHT, "e2", "1")
end
function test_38_san_move_piece_amb_rank_capture()
...
function test_39_san_move_piece_amb_rank_check()
...
function test_40_san_move_piece_amb_rank_capture_check()
    assert_move("Q1xf3+", QUEEN, "f3", "1", true, "+")
    assert_move("R2xd7#", ROOK, "d7", "2", true, "#")
    assert_move("B3xf8+", BISHOP, "f8", "3", true, "+")
    assert_move("N1xe2#", KNIGHT, "e2", "1", true, "#")
end
function test_41_san_move_piece_amb_square()
    assert_move("Qa8d8", QUEEN, "d8", "a8")
    assert_move("Rd1f1", ROOK, "f1", "d1")
    assert_move("Be5g7", BISHOP, "g7", "e5")
    assert_move("Nf8h7", KNIGHT, "h7", "f8")
end
function test_42_san_move_piece_amb_square_capture()
...
function test_43_san_move_piece_amb_square_check()
...
function test_53_fen_piece_placement()
    local expected = {
...
function test_56_fen_castle_black()
...
function test_57_fen_castle_none()
...
function test_61_fen()
    ...
    assert(move.fen:match"rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq c6 0 2")
    assert(move.fen:match"rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2")
end
